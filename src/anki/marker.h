...
constexpr const char *EXPRESSION = "expression";
constexpr const char *FURIGANA = "furigana";
constexpr const char *FURIGANA_PLAIN = "furigana-plain";
...
constexpr const char *KUNYOMI = "kunyomi";
constexpr const char *ONYOMI = "onyomi";
constexpr const char *STROKE_COUNT = "stroke-count";
